    ...
    <section class="container mx-auto my-[70px]">
        <div class="flex flex-col items-center justify-center my-[70px]">
            ...
            <div class="flex gap-8 mt-4">
                <a href="https://www.facebook.com/TheMatchArtist" target="_blank" rel="noopener noreferrer">
                    <svg
                ...
                <a href="https://www.instagram.com/thematchartist/" target="_blank" rel="noopener noreferrer">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="50"
                        height="50"
        ...
        <div class="grid grid-cols-4 gap-8 items-center px-8">
            ...
            <a
                ...
                target="_blank"
            >
                <nuxt-img src="/images/client/footer_logo_4.webp" />
            </a>
        </div>
    </section>
</template>
